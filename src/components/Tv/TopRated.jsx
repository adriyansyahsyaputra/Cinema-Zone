...
import { getTopRatedTv } from "../../Api/tv-api";

export default function TopRated() {
    const [topRated, setTopRated] = useState([])

    useEffect(() => {
        getTopRatedTv().then((data) => setTopRated(data))
    })
    ...
    return (
        ...
        <div className="container mt-20">
            <div className="w-full flex items-center my-10">
                ...
                <h1 className="text-white font-semibold font-inter text-xl md:text-3xl mx-4">Top Rated</h1>
                <span className="flex-grow h-px bg-slate-300"></span>
            </div> 
            {/* Cards */}
